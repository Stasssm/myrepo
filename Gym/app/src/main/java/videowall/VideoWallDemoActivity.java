...
import videowall.FlippingView.Listener;
...
public class VideoWallDemoActivity extends Activity implements
  ...
  private String PLAYLIST_ID ;//= "PLD2F95457214C8B3C";
  public static final String EXTRA_LIST ="videowall.list";
 ...
 // private ViewGroup horizontalView;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    PLAYLIST_ID =this.getIntent().getStringExtra(EXTRA_LIST);
    ViewGroup group = new LinearLayout(this);

    scrollview = new ScrollView(this);

   // horizontalView = new HorizontalScrollView(this);
    ViewGroup viewFrame = new RelativeLayout(this);
    group.addView(scrollview,LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT);
    scrollview.addView(viewFrame,LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT);
    //horizontalView.addView(viewFrame,LayoutParams.MATCH_PARENT,LayoutParams.MATCH_PARENT);
    ...
    viewFrame.addView(imageWallView, LayoutParams.WRAP_CONTENT,LayoutParams.WRAP_CONTENT);
    ...
    playerView.setId(R.id.my_youtube_framelayout);
    ...
    getFragmentManager().beginTransaction().add(playerView.getId(), playerFragment).commit();
